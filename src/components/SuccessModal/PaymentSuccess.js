...
const PaymentSuccessModal = ({
  ...
  const { REACT_APP_PAYMENT_WIDGET_URL } = process.env;
  const link = `${REACT_APP_PAYMENT_WIDGET_URL}/payment-pages/${paymentLink}`;
  const history = useHistory();

  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative md:w-430px my-6 mx-auto md:max-w-3xl w-full">
          <div className="border-0 rounded-lg shadow-xl relative flex flex-col w-full bg-white dark:bg-gray-900 outline-none focus:outline-none">
            ...
            <div className="w-full relative md:px-6 px-2 py-10 flex-auto">
              <div className="">
                ...
                <div className="text-center mt-4 text-lightnavyblue dark:text-gray-400">
                  <div className="border border-gray-100 h-10 mx-9 rounded-tr-sm flex items-center justify-center rounded-tl-sm">
                    <p className=" text-ellipsis whitespace-nowrap w-auto mx-2 items-center overflow-hidden text-center">
                      {link}
                    </p>
                  </div>
                  <CopyToClipboard
                      ...
                      <span className="ml-2">
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M4.83268 0.166748H10.666C11.3382 0.166748 11.8327 0.661249 11.8327 1.33341V7.16675C11.8327 7.83891 11.3382 8.33341 10.666 8.33341H8.33268V10.6667C8.33268 11.3389 7.83818 11.8334 7.16602 11.8334H1.33268C0.660516 11.8334 0.166016 11.3389 0.166016 10.6667V4.83341C0.166016 4.16125 0.660516 3.66675 1.33268 3.66675H3.66602V1.33341C3.66602 0.661249 4.16052 0.166748 4.83268 0.166748ZM3.66602 4.83341H1.33268V10.6667H7.16602V8.33341H4.83268C4.16052 8.33341 3.66602 7.83891 3.66602 7.16675V4.83341ZM4.83268 1.33341V7.16675H10.666V1.33341H4.83268Z"
                            fill="#0066FF"
                          />
                        </svg>
                      </span>
